...
test('api structure', () => {
	const api = new APIClient(API_CREDENTIALS);
	...
	expect(typeof api.apiKeys.retrieve).toBe('function');
	expect(typeof api.apiKeys.create).toBe('function');
	expect(typeof api.apiKeys.update).toBe('function');
	expect(typeof api.apiKeys.delete).toBe('function');
...
test('ajax structure', () => {
	const api = new APIClient(AJAX_CREDENTIALS);
	expect(typeof api.public.products.list).toBe('function');
	expect(typeof api.public.products.retrieve).toBe('function');
	expect(typeof api.public.sitemap.list).toBe('function');
	expect(typeof api.public.sitemap.retrieve).toBe('function');
	expect(typeof api.public.cart.retrieve).toBe('function');
	expect(typeof api.public.pages.list).toBe('function');
	expect(typeof api.public.pages.retrieve).toBe('function');
});
...
test('static methods', () => {
	expect(typeof APIClient.authorizeInWebStore).toBe('function');
});
